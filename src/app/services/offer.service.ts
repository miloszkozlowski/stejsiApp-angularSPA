...
export class OfferService {
    ...
    createNewPackageType(packageType: PackageTypeWriteModel): Observable<any> {
        return this.http
            .post<PackageTypeModel>(environment.serverPath + this.endpoint, packageType)
            .pipe(
                switchMap(resp => {
                    this.restartLoad();
    ...
    loadNextSlice(): Observable<any> {
        ...
        return this.http
            .get<PageModel<PackageTypeModel>>(environment.serverPath + this.endpoint, {params: params})
            .pipe(tap(page => {
    ...
    removalRequest(id: number): Observable<any> {
        ...
        return this.http
            .delete(environment.serverPath + this.endpoint + '/' + id)
            .pipe(
                // tap(() => {
